...
# ================================================
# This notebook is FULLY SELF-CONTAINED - no git clone needed.
# Downloads data files directly and includes all code inline.
#
# Methods: PySINDy, WSINDy, RobustIDENT (no WeakIDENT)
# Runtime: T4 GPU recommended (but CPU works too)
# Time: ~30-60 minutes for all PDEs

# ============== CELL 1: Install Dependencies ==============
!pip install pysindy==1.7.5 tqdm --quiet
print("✅ Dependencies installed")

# ============== CELL 2: Download Data Files ==============
import os
