...
\caption{Cumulative distribution of regret. The near-vertical rise at $x=0$ indicates that 97.06\% of held-out test predictions achieve the same error as the oracle. Most non-zero regrets are small (median non-zero regret $<$ 0.01).}
